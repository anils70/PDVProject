...
def test_code_converter():
    ...
    Inputs:
      codeinfo       - A country code information dictionary
    Output:
      A dictionary with plot code key and data country code value.
    """
    codeinfo = {
    ...
    test_dict = build_country_code_converter(codeinfo)
    print(test_dict)
...
def reconcile_countries_by_code(codeinfo, plot_countries, gdp_countries):
    ...
    """
    recon_gdp_countries_dict = {}
    missing_plot_countries = set()
    ...
    return recon_gdp_countries_dict, missing_plot_countries
...
def build_map_dict_by_code(gdpinfo, codeinfo, plot_countries, year):
    ...
    gdp_countries = read_csv_as_nested_dict(gdpinfo.get("gdpfile"),\
    gdpinfo.get("country_code"), gdpinfo.get("separator"), gdpinfo.get("quote"))
    #print("gdp_countries:")
    #print(gdp_countries)
...
def test_build_map_dict_by_code():
    """
    test
    """
    gdpinfo = {
    ...
    # Get gdp countries
    #gdp_countries_dict = read_csv_as_nested_dict(gdpinfo.get("gdpfile"),\
    #gdpinfo.get("country_code"), gdpinfo.get("separator"), gdpinfo.get("quote"))

    res = build_map_dict_by_code(gdpinfo, codeinfo, pygal_countries, "1960")
    print(res[0])
    print(res[1])
    print(res[2])
